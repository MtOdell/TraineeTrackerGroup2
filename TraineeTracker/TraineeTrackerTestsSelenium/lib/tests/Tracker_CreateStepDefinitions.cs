...
namespace TraineeTrackerTestsSelenium.lib.tests
{
    ...
    public class Tracker_CreateStepDefinitions : Tracker_Shared
    {
        ...
        [BeforeScenario("I enter details about a tracker and click Create", Order = 3)]
        public void GetTrackerCount()
        {
            _trackerCount = Website.SeleniumDriver.FindElements(By.Id("row_heading")).Count;
        }
        ...
        {
            int newCount = Website.SeleniumDriver.FindElements(By.Id("row_heading")).Count;
